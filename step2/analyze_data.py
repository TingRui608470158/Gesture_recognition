...
gesture_id = ["stop", "clockwise", "anticlockwise", "down", "left", "right", "up"]
...
while i < len(class_value[0]):
    ...
    plt_text = "Row:"+str(i)+"/"+str(len(class_value[0])) + ", label:" + str(class_value[0][i])+","+ gesture_id[class_value[0][i]]
